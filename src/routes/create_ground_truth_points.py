...
def main():
    ...
    try:
        ...
        print("=" * 60)
        print(f"Tiles processed: {summary['successful_tiles']}/{summary['total_tiles']}")
        print(f"Total points generated: {summary['total_points']}")
        print(f"Average points per tile: {summary['total_points'] / max(summary['successful_tiles'], 1):.1f}")
